...
`code of conduct <https://github.com/aragilar/h5preserve/blob/master/code_of_conduct.md>`_
whether it is improvements to the documentation or examples, bug reports or code
improvements.

Reporting Bugs
--------------
Bugs should be reported to https://github.org/aragilar/h5preserve. Please
...
-------------------------
The main repository is https://github.org/aragilar/h5preserve, please make pull
